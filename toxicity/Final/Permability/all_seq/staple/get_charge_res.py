...
dictt = {'R8': 'N[C@@](CCCCCCC=3)(C)C(=O)N[C@@](CCCCCCC=3)(C)C(=O)',
         ...
         'B8': 'NC(CCCC=3)(CCCC=4)C(=O)NC(CCCC=3)(CCCC=4)C(=O)',
         'FITC': 'C(NC1=CC=C2C(=C1)C4(OC2=O)C3=C(C=C(C=C3)O)OC5=C4C=CC(=C5)O)(=S)C(NC1=CC=C2C(=C1)C4(OC2=O)C3=C(C=C(C=C3)O)OC5=C4C=CC(=C5)O)(=S)',
         'M': 'N[C@H](CCSC)C(=O)N[C@H](CCSC)C(=O)',
         'BAla': 'NCCC(=O)NCCC(=O)',
         'A': 'N[C@H](C)C(=O)N[C@H](C)C(=O)',
         'P': 'N1CCCC1C(=O)N1CCCC1C(=O)',
         'EEA': 'NCCOCCOCCNC(=O)CCC(=O)NCCOCCOCCNC(=O)CCC(=O)',
         'Q': 'N[C@H](CCC(N)=O)C(=O)N[C@H](CCC(N)=O)C(=O)',
         'S5': 'N[C@](CCCC=3)(C)C(=O)N[C@](CCCC=3)(C)C(=O)',
         'V': 'N[C@H](C(C))C(=O)N[C@H](C(C))C(=O)',
         'pff': 'N[C@@H](Cc1c(F)c(F)c(F)c(F)c1(F))C(=O)N[C@@H](Cc1c(F)c(F)c(F)c(F)c1(F))C(=O)',
         'S8': 'N[C@](CCCCCCC=3)(C)C(=O)N[C@](CCCCCCC=3)(C)C(=O)',
         'PEG5': 'NCCOCCOCCOCCOCCOCCOCCC(=O)NCCOCCOCCOCCOCCOCCOCCC(=O)',
         'G': 'NCC(=O)NCC(=O)',
         'C': 'N[C@H](CS)C(=O)N[C@H](CS)C(=O)',
         'W': 'N[C@H](Cc1c[nH]c2ccccc12)C(=O)N[C@H](Cc1c[nH]c2ccccc12)C(=O)',
         'H': 'N[C@H](Cc1c[nH]cn1)C(=O)N[C@H](Cc1c[nH]cn1)C(=O)',
         'S': 'N[C@H](CO)C(=O)N[C@H](CO)C(=O)',
         'Y': 'N[C@H](Cc1ccc(O)cc1)C(=O)N[C@H](Cc1ccc(O)cc1)C(=O)',
         'R5': 'N[C@@](CCCC=3)(C)C(=O)N[C@@](CCCC=3)C(=O)',
         'R': 'N[C@H](CCCNC(=[NH2+])N)C(=O)N[C@H](CCCNC(=[NH2+])N)C(=O)',
         'T': 'N[C@H]([C@H](O)C)C(=O)N[C@H]([C@H](O)C)C(=O)',
         'I': 'N[C@H]([C@@H](C)CC)C(=O)N[C@H]([C@@H](C)CC)C(=O)',
         'NL': 'N[C@@H](CCCC)C(=O)N[C@@H](CCCC)C(=O)',
         'PEG': 'NCCOCCOCC(=O)NCCOCCOCC(=O)',
         'D': 'N[C@H](CC(=O)[O-])C(=O)N[C@H](CC(=O)[O-])C(=O)',
         'B5': 'NC(CCCC=3)(CCCC=4)C(=O)NC(CCCC=3)(CCCC=4)C(=O)',
         'B88':'N[C@H](C)C(=O)N[C@@](CCCC=3)(C)C(=O)N[C@H](C)C(=O)NC(CCCC=3)(CCCC=4)C(=O)N[C@H](C)C(=O)N[C@@](CCCC=4)(C)C(=O)N[C@H](C)C(=O)',
         'PEG2': 'NCCOCOCCOCCC(=O)NCCOCOCCOCCC(=O)',
         'L': 'N[C@H](CC(C)C)C(=O)N[C@H](CC(C)C)C(=O)',
         'AC': 'CC(=O)CC(=O)',
         'E': 'N[C@H](CCC(=O)[O-])C(=O)N[C@H](CCC(=O)[O-])C(=O)'}
import numpy as np
all = tuple(dictt.keys())
for i in all:
    if i not in ['B5','B8','R5','R8','S5','S8','FITC']:
        for j in all:
            if j not in ['B5','B8','R5','R8','S5','S8','FITC','BAla']:
                if i != j:
                    None##dictt[i+'_'+j] = dictt[i][:len(dictt[i])//2]+dictt[j][:len(dictt[j])//2]
data_dictt=pd.DataFrame(None)
data_dictt['res']=dictt.keys()
...
if True:
    ...
    MMFF['bond1'] = bonds1
    MMFF['bond2'] = bonds2
    MMFF.to_csv('res_charge.csv',index=0)
die
