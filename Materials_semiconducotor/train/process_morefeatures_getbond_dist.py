...
def get_dist(atom_typeA,atom_typeB,temp,cutoff=6.5):
    if True:
        ...
        dist = dist[(dist>0.01) & (dist <= cutoff)] #get all covalent bonds
        return list(dist)
...
data_features[5] = data_features[5].astype(np.int32)
if True:
    np.save('../train_bond_distribution.npy',bond_distribution)
