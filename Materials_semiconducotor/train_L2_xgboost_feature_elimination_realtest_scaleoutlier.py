...
plt.plot(hist2[0],hist2[1],'ro');plt.ylim([0.05,0.1]);plt.xlim([0.05,0.1]);plt.show()
plt.plot(hist1[0],hist1[1],'ro');plt.ylim([0.015,0.035]);plt.xlim([0.015,0.035]);plt.show()
'''
hist1 = [[],[]]
hist2 = [[],[]]
offsetB,offsetA = 8 ,0.2
name = 'benchmark'
