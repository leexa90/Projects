...
for permutation_seed in [8422, 7171, 5676, 1086, 4111, 3579, 3088, 2244, 2321, 2385, 1732,
                       4736, 5967, 4584, 8126, 6047, 2107, 1549, 8218, 8019, 1766, 9432,
                       1929, 4073,   57,  582, 8753, 2713, 1050, 5496, 8009, 9401, 9492,
                       5764,  275, 5339, 3075,   87, 7602, 6369, 1316, 1989, 2864, 1541,
                       3586, 7868,  563, 5450, 2143, 4076]:
    ...
    comps=1
    for seed in seeds:
        train = train.sample(2400,random_state=seed+permutation_seed).reset_index(drop=True)
        for i in range(0,10):
